...
%     anParameter.minPlotIntervall = 1;
%     anParameter.maxPlotIntervall = 1;%numel(anDataAll.timeStart);
%     anParameter.intervall = datenum([0 0 0 0 0 6]);
% end
% 
...
anParameter.intervallVec = [0 0 0 0 0 3600];
anParameter.intervall = datenum(anParameter.intervallVec);
...
%     figure(3);    clf;
%     clear hist2
%     choosenParticle = ((anDataAll.partIsIce{cnt} | anDataAll.partIsWater{cnt}) & ...
%         anDataAll.imEquivDiaOldSizes{cnt} > anParameter.lowSize*1e-6 &...
%         anDataAll.pDiam{cnt} < anParameter.maxSize*1e-6);
%     
%     
%     cnt = 1%anParameter.spatialDisCase;
%     subplot(3,2,1);
%     hold on;
%     [a, b] = hist(anDataAll.xPos{cnt}(choosenParticle).*1e3,20);
...
%     subplot(3,2,3);
%     hold on;
%     [a b] = hist(anDataAll.yPos{cnt}(choosenParticle).*1e3,20);
%     a = a./(sum(a)/numel(a))*100-100;
%     bar(b,a)
%     xlim([-1.68 1.68]);
%     ylim([-5.5 5.5]);
...
%     subplot(3,2,5);
%     hold on;
%     [a b] = histc(anDataAll.zPos{cnt}(choosenParticle).*1e3,1:21);
%     a=a(1:19);
%     a = a./(sum(a)/numel(a))*100-100;
%     bar(1:19,a)
%     ylim([-75 75]);
...
%     choosenParticle = ((anDataAll.partIsIce{cnt} | anDataAll.partIsWater{cnt}) & ...
%         anDataAll.imEquivDiaOldSizes{cnt} > anParameter.lowSize*1e-6 &...
%         anDataAll.imEquivDiaOldSizes{cnt} < anParameter.maxSize*1e-6);
%     
%     
%     cnt = 1%anParameter.spatialDisCase;
%     
...
%         anDataAll.imEquivDiaOldSizes{cnt} > anParameter.lowSize*1e-6 &...
%         anDataAll.imEquivDiaOldSizes{cnt} < anParameter.maxSize*1e-6& ...
%         (anDataAll.xPos{cnt} <-0.5e-3 | anDataAll.xPos{cnt} >0.5e-3));
%     
%     subplot(3,2,3);
%     hold on;
%     bln = .5e-3;
%     blnz= 1e-3;
%     x = anDataAll.yPos{cnt}(choosenParticle);
%     y = anDataAll.zPos{cnt}(choosenParticle);
%     x(isnan(x))=0;
%     y(isnan(y))=0;
%     xrange = min(x):bln:max(x);
%     yrange = min(y):blnz:max(y);
%     z = [x; y]';
%     count = hist2([x;y]',xrange,yrange);
%     count = count./(sum(count(:))/numel(count)) *100-100;
%     count = interp2(count,4);
...
%     contourf(yrange,xrange,count);
%     
%     title('Relative Counts [%] (X pos. outer 1 mm)');
%     ylabel('Y position (mm)');
%     xlabel('Z position (mm)');
%     caxis([-50 50]);
%     colorbar
...
%         anDataAll.imEquivDiaOldSizes{cnt} > anParameter.lowSize*1e-6 &...
%         anDataAll.imEquivDiaOldSizes{cnt} < anParameter.maxSize*1e-6 & ...
%         anDataAll.xPos{cnt} >-1.7e-3 & anDataAll.xPos{cnt} <1.7e-3);
%     
%     subplot(3,2,5);
%     hold on;
%     bln = .5e-3;
...
%     contourf(yrange,xrange,count);
%     
%     title('Relative Counts [%] (X pos. inner 1 mm)');
%     ylabel('Y position (mm)');
%     xlabel('Z position (mm)');
%     caxis([-50 50]);
%     colorbar
...
%     choosenParticle = ((anDataAll.partIsIce{cnt} | anDataAll.partIsWater{cnt}) & ...
%         anDataAll.imEquivDiaOldSizes{cnt} > anParameter.lowSize*1e-6 &...
%         anDataAll.imEquivDiaOldSizes{cnt} < 10*1e-6);
%     
%     subplot(3,2,2);
%     hold on;
%     bln = .5e-3;
...
%     contourf(yrange,xrange,count);
%     
%     title('Relative Counts [%] (X pos. outer 1 mm & d < 10um)');
%     ylabel('Y position (mm)');
%     xlabel('Z position (mm)');
%     caxis([-50 50]);
%     colorbar
...
%     contourf(yrange,xrange,count);
%     
%     title('Relative Counts [%] (X pos. inner 1 mm & d < 10um)');
%     ylabel('X position (mm)');
%     xlabel('Z position (mm)');
%     caxis([-50 50]);
%     colorbar
