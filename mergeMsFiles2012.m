...
function outFile = mergeMsFiles2012(folderMSFile, nameMSFile, nameASFile, folderASFile)
    ...
    temp = temp.outFile;
            ...
            for cnt2 = 1:numel(temp.pStats.dateNumPar)
                if temp.pStats.dateNumPar(cnt2) < 4e5
                    timeStamp = [str2num(temp.folderPSFile(4:7)) str2num(temp.folderPSFile(9:10)) str2num(temp.folderPSFile(12:13))];
