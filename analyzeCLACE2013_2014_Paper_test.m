...
anParameter.Drive = 'C:\';
anParameter.FolderData = fullfile('Z:\3_Data\CLACE2013');
anParameter.ParInfoFolder = fullfile(anParameter.Drive, 'test');
...
if ~isfield('anDataAll','measMeanV');
    for cnt = 1:numel(anDataAll.timeStart)
        anDataAll.sonicIndice{cnt} = sort([find(dataSonic.Date_Num >= anDataAll.timeStart(cnt),1,'first') ...
...
save(['CLACE2013_All_' anParameter.asSearch '_' num2str(anParameter.intervallVec(6)) 'secStat.mat'],'anDataAll');