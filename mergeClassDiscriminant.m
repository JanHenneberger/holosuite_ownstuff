...
dataTree.classificatoinDiscriminant = ClassificationDiscriminant.fit(dataTree.X,dataTree.Y,...
    'PredictorNames', dataTree.varNames,...
    'discrimType','quadratic');
dataTree.classificationTree = ClassificationTree.fit(dataTree.X,dataTree.Y,...
    'PredictorNames', dataTree.varNames,...
    'minleaf',12, 'AlgorithmForCategorical','PCA');
