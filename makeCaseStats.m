...
caseStats.duration = caseStats.cntIntervall*100/3600;
...
caseStats.IWConcMean = grpstats(real(anData.IWConcentraction(tmpInt)),oTmp,'mean');
caseStats.IWConcMean = caseStats.IWConcMean*1000;
caseStats.IWConcStd = grpstats(real(anData.IWConcentraction(tmpInt)),oTmp,'std');
caseStats.IWConcStd = caseStats.IWConcStd*1000;
caseStats.IWConcStdMean = grpstats(real(anData.IWConcentraction(tmpInt)),oTmp,'sem');
caseStats.IWConcStdMean = caseStats.IWConcStdMean*1000;
...
caseTable = table(caseStats.dateStart, caseStats.timeStart, caseStats.timeEnd, ...    
    ...
    num2str(caseStats.cntIntervall), num2str(caseStats.duration, '%1.1f'),...
    ...
    num2str(caseStats.IWConcMean,'%1.0f'), num2str(caseStats.IWConcStdMean,'%1.0f'),...
    'VariableNames',{'Date'; 'TimeStart'; 'TimeEnd'; ...
    'TempMean'; 'TempStd'; 'WindVelMean'; 'WindVelStd'; ...
    'Intervalls'; 'Duration'; ...
    'TWCMean'; 'TWCStd'; 'LWCMean'; 'LWCStd'; 'IWCMean'; 'IWCStd';...
    'IWConcMean';'IWConcStd'});
