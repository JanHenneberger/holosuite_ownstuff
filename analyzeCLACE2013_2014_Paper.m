...
%clear dataAll
anParameter.timeStart = datenum([2013 1 29 0 0 0]);
anParameter.timeEnd = datenum([2013 2 15 0 0 0]);
...
save(['CLACE2013-10-Ice-All-' anParameter.asSearch '-' num2str(anParameter.intervallVec(6)) 'secStat.mat'],'anDataAll','-v7.3');