...
if ~isfield('anDataAll','timeStart');
    for cnt = 1:numel(anDataAll.intTimeStart)
        ...
        anDataAll.meanD(cnt)   = nanmean(dataAll.pStats.pDiamOldSizesOldThresh...
            (tmp & dataAll.pStats.partIsReal & dataAll.pStats.pDiamOldSizesOldThresh > anParameter.lowSize*1e-6 &...
            dataAll.pStats.pDiamOldSizesOldThresh < anParameter.maxSize*1e-6));
...
save(['SYNHOLO-New-' anParameter.asSearch '-' num2str(anParameter.intervallVec(6)) 'secStat.mat'],'anDataAll','-v7.3');