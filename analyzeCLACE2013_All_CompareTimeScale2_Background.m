...
if ~exist('allDataRaw','var');
    ...
    allDataRaw = load('Background.mat');
...
chooseCase =2;
plotXLimAll(1,:)  = [datenum([2013 2 4 0 0 0]) datenum([2013 2 5 0 0 0])];
plotXLimAll(2,:)  = [datenum([2013 2 5 0 0 0]) datenum([2013 2 6 0 0 0])];
...
for cnt = 1:numel(allData)
    ...
    anData2{cnt}.plotXLim = [allData{cnt}.timeStart(anData2{cnt}.plotXLimInd(1)),...
        allData{cnt}.timeStart(anData2{cnt}.plotXLimInd(1))];
end
if 0
    figure(5)
    caseforPlot = 2;
...
%         'LineWidth',2);
    ...
    set(gca,'YScale','log');
    set(gca,'XScale','log');
    title([datestr(allData{1}.timeStart(anData2{1,indForSpectra}.plotXLimInd(1)),'dd/mm/yyyy') ' ' ...
        datestr(allData{1}.timeStart(anData2{1,indForSpectra}.plotXLimInd(1)),'HH:MM') '-'...
        datestr(allData{1}.timeStart(anData2{1,indForSpectra}.plotXLimInd(2)),'HH:MM')]);
