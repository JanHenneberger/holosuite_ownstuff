function plot_SpectraByTemperatureWindDirection(anData, cntFig)
...
figure(cntFig)
    ...
    hold on
    choseDataTmp = anData.oTemperature(anData.chosenDataWind);
    
    
    plotData = anData.water.histRealCor(:,anData.chosenDataWind);
    ...
    if anData.savePlots
        fileName = ['All_Spectra_Temp_' anData.chosenWindDirection];
