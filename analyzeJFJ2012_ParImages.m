...
anParameter.ParInfoFolder ='F:\HOLOLAB\ms-files';
%fileNr = 5;
%fileNr = 13;
%fileNr = 23;
%fileNr = 30;
...
for cnt2 = 1:numel(anParameter.ParInfoFiles)
    if  rem(cnt2,everyFile)==0
        ...
        anParameter.cfg = config(fullfile('F:\HOLOLAB\', 'holoviewer.cfg'));
        ...
        anParameter.ParImageFolder = fullfile('F:\HOLOLAB\Particle',anParameter.ParInfoFiles{fileNr}(1:end-7));
