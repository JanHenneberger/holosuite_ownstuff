...
% Last Modified by GUIDE v2.5 09-Apr-2013 17:09:20
...
if isempty(varargin)
    ...
    if numel(varargin) == 2
        ...
        handles.tree = load('ClassificatonTree-13-04-09andCalibration.mat');
        handles.tree = handles.tree.treeFile;
    end
end
...
handles.pStatsTableData(15,7) = min(handles.dataAll.pStats.pDiamMean(handles.choosen.Data));
handles.pStatsTableData(16,7) = min(handles.dataAll.pStats.pDiamOldThresh(handles.choosen.Data));
handles.pStatsTableData(17,7) = min(handles.dataAll.pStats.imEquivDiaOldSizes(handles.choosen.Data));
...
handles.pStatsTableData(15,8) = max(handles.dataAll.pStats.pDiamMean(handles.choosen.Data));
handles.pStatsTableData(16,8) = max(handles.dataAll.pStats.pDiamOldThresh(handles.choosen.Data));
handles.pStatsTableData(17,8) = max(handles.dataAll.pStats.imEquivDiaOldSizes(handles.choosen.Data));
...
handles.pStatsTableData(15,2) = nanmean(handles.dataAll.pStats.pDiamMean(handles.choosen.Data));
handles.pStatsTableData(16,2) = nanmean(handles.dataAll.pStats.pDiamOldThresh(handles.choosen.Data));
handles.pStatsTableData(17,2) = nanmean(handles.dataAll.pStats.imEquivDiaOldSizes(handles.choosen.Data));
...
handles.pStatsTableData(15,1) = handles.dataAll.pStats.pDiamMean(handles.cntParticleAll);
handles.pStatsTableData(16,1) = handles.dataAll.pStats.pDiamOldThresh(handles.cntParticleAll);
handles.pStatsTableData(17,1) = handles.dataAll.pStats.imEquivDiaOldSizes(handles.cntParticleAll);
...
if any(handles.parClass=='Water');
    ...
    handles.pStatsTableData(2,3) = nanmean(handles.dataAll.pStats.xPos(handles.parClass=='Water' & handles.choosen.Data));
    handles.pStatsTableData(3,3) = nanmean(handles.dataAll.pStats.yPos(handles.parClass=='Water' & handles.choosen.Data));
    handles.pStatsTableData(4,3) = nanmean(handles.dataAll.pStats.zPos(handles.parClass=='Water' & handles.choosen.Data));
    handles.pStatsTableData(5,3) = nanmean(handles.dataAll.pStats.imXPos(handles.parClass=='Water' & handles.choosen.Data));
    handles.pStatsTableData(6,3) = nanmean(handles.dataAll.pStats.imYPos(handles.parClass=='Water' & handles.choosen.Data));
    ...
    handles.pStatsTableData(15,3) = nanmean(handles.dataAll.pStats.pDiamMean(handles.parClass=='Water' & handles.choosen.Data));
    handles.pStatsTableData(16,3) = nanmean(handles.dataAll.pStats.pDiamOldThresh(handles.parClass=='Water' & handles.choosen.Data));
    handles.pStatsTableData(17,3) = nanmean(handles.dataAll.pStats.imEquivDiaOldSizes(handles.parClass=='Water' & handles.choosen.Data));
    handles.pStatsTableData(18,3) = nanmean(handles.dataAll.pStats.imMeanRadii(handles.parClass=='Water' & handles.choosen.Data));
    
    handles.pStatsTableData(19,3) = nanmean(handles.dataAll.pStats.imStdRadii(handles.parClass=='Water' & handles.choosen.Data));
...
if any(handles.parClass=='Ice');
    ...
    handles.pStatsTableData(2,4) = nanmean(handles.dataAll.pStats.xPos(handles.parClass=='Ice' & handles.choosen.Data));
    handles.pStatsTableData(3,4) = nanmean(handles.dataAll.pStats.yPos(handles.parClass=='Ice' & handles.choosen.Data));
    handles.pStatsTableData(4,4) = nanmean(handles.dataAll.pStats.zPos(handles.parClass=='Ice' & handles.choosen.Data));
    handles.pStatsTableData(5,4) = nanmean(handles.dataAll.pStats.imXPos(handles.parClass=='Ice' & handles.choosen.Data));
    handles.pStatsTableData(6,4) = nanmean(handles.dataAll.pStats.imYPos(handles.parClass=='Ice' & handles.choosen.Data));
    ...
    handles.pStatsTableData(15,4) = nanmean(handles.dataAll.pStats.pDiamMean(handles.parClass=='Ice' & handles.choosen.Data));
    handles.pStatsTableData(16,4) = nanmean(handles.dataAll.pStats.pDiamOldThresh(handles.parClass=='Ice' & handles.choosen.Data));
    handles.pStatsTableData(17,4) = nanmean(handles.dataAll.pStats.imEquivDiaOldSizes(handles.parClass=='Ice' & handles.choosen.Data));
    handles.pStatsTableData(18,4) = nanmean(handles.dataAll.pStats.imMeanRadii(handles.parClass=='Ice' & handles.choosen.Data));
    
    handles.pStatsTableData(19,4) = nanmean(handles.dataAll.pStats.imStdRadii(handles.parClass=='Ice' & handles.choosen.Data));
...
if any(handles.parClass=='Artefact');
    ...
    handles.pStatsTableData(2,5) = nanmean(handles.dataAll.pStats.xPos(handles.parClass=='Artefact' & handles.choosen.Data));
    handles.pStatsTableData(3,5) = nanmean(handles.dataAll.pStats.yPos(handles.parClass=='Artefact' & handles.choosen.Data));
    handles.pStatsTableData(4,5) = nanmean(handles.dataAll.pStats.zPos(handles.parClass=='Artefact' & handles.choosen.Data));
    handles.pStatsTableData(5,5) = nanmean(handles.dataAll.pStats.imXPos(handles.parClass=='Artefact' & handles.choosen.Data));
    handles.pStatsTableData(6,5) = nanmean(handles.dataAll.pStats.imYPos(handles.parClass=='Artefact' & handles.choosen.Data));
    ...
    handles.pStatsTableData(15,5) = nanmean(handles.dataAll.pStats.pDiamMean(handles.parClass=='Artefact' & handles.choosen.Data));
    handles.pStatsTableData(16,5) = nanmean(handles.dataAll.pStats.pDiamOldThresh(handles.parClass=='Artefact' & handles.choosen.Data));
    handles.pStatsTableData(17,5) = nanmean(handles.dataAll.pStats.imEquivDiaOldSizes(handles.parClass=='Artefact' & handles.choosen.Data));
    handles.pStatsTableData(18,5) = nanmean(handles.dataAll.pStats.imMeanRadii(handles.parClass=='Artefact' & handles.choosen.Data));
    
    handles.pStatsTableData(19,5) = nanmean(handles.dataAll.pStats.imStdRadii(handles.parClass=='Artefact' & handles.choosen.Data));
...
if any(handles.parClass=='Unknown');
    ...
    handles.pStatsTableData(2,6) = nanmean(handles.dataAll.pStats.xPos(handles.parClass=='Unknown' & handles.choosen.Data));
    handles.pStatsTableData(3,6) = nanmean(handles.dataAll.pStats.yPos(handles.parClass=='Unknown' & handles.choosen.Data));
    handles.pStatsTableData(4,6) = nanmean(handles.dataAll.pStats.zPos(handles.parClass=='Unknown' & handles.choosen.Data));
    handles.pStatsTableData(5,6) = nanmean(handles.dataAll.pStats.imXPos(handles.parClass=='Unknown' & handles.choosen.Data));
    handles.pStatsTableData(6,6) = nanmean(handles.dataAll.pStats.imYPos(handles.parClass=='Unknown' & handles.choosen.Data));
    ...
    handles.pStatsTableData(15,6) = nanmean(handles.dataAll.pStats.pDiamMean(handles.parClass=='Unknown' & handles.choosen.Data));
    handles.pStatsTableData(16,6) = nanmean(handles.dataAll.pStats.pDiamOldThresh(handles.parClass=='Unknown' & handles.choosen.Data));
    handles.pStatsTableData(17,6) = nanmean(handles.dataAll.pStats.imEquivDiaOldSizes(handles.parClass=='Unknown' & handles.choosen.Data));
    handles.pStatsTableData(18,6) = nanmean(handles.dataAll.pStats.imMeanRadii(handles.parClass=='Unknown' & handles.choosen.Data));
    
    handles.pStatsTableData(19,6) = nanmean(handles.dataAll.pStats.imStdRadii(handles.parClass=='Unknown' & handles.choosen.Data));
...
handles.tree.X = getTreeX(handles, handles.choosen.Data);
handles.tree.Y = handles.parClass;
handles.tree.Y = droplevels(handles.tree.Y,{'notSpez','Unknown'});
handles.tree.Y = handles.tree.Y(handles.choosen.Data);
...
Xdata = getTreeX(handles,true(1,numel(handles.choosen.Data)));
handles.dataAll.pStats.predictedClass = predict(tree.classificationTree, Xdata);
if isfield(tree,'classificationTreeShort')
    handles.dataAll.pStats.predictedClassShort = predict(tree.classificationTreeShort, Xdata);
end
