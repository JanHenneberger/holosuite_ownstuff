function h = plotGroupBoxplots(anData, B)
...
h=boxplot(double(anData.TWConcentraction(plotInd)), B(plotInd) ,'symbol','r+','outliersize',4,'labelorientation','inline');
hold on
...
set(gca,'YLim',[1/mean(anData.sample.VolumeReal)/1000000 5e0])
